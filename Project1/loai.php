  ...
  <div class="container">
    <div class="d-flex position-relative menu-list">
        ...
        <div class="sub_nav">
          <div class="sub_filter">
            <div class="list-unstyled sub_list-attr list_2col m-0 p-0 d-flex flex-wrap">
              <div class="danhmuc-2">
                <a href="index.php?page=loai&id=1" title="Laptop Dell Mới" class="title-danhmuc-2">Laptop Dell Mới</a>
              ...
              <div class="danhmuc-2">
                <a href="index.php?page=loai&id=12" title="Laptop Asus Mới" class="title-danhmuc-2">Laptop Asus Mới</a>
                <div class="danhmuc-3 d-flex flex-wrap">
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
        ...
        <div class="sub_nav">
          <div class="sub_filter">
            <div class="list-unstyled sub_list-attr list_2col m-0 p-0 d-flex flex-wrap">
              ...
              <div class="danhmuc-2">
                <a href="/surface-book.html" title="Surface Book" class="title-danhmuc-2">Surface
                  Book</a>
                <div class="danhmuc-3 d-flex flex-wrap">
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
            ...
            <div class="list-unstyled sub_list-attr list_2col m-0 p-0 d-flex flex-wrap">
              <div class="danhmuc-2">
                ...
                <div class="danhmuc-3 d-flex flex-wrap">
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/dell-alienware-like-new.html" title="Dell Alienware Like new">Dell
                      Alienware Like new</a>

                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/dell-g-seri-like-new.html" title="Dell G-Seri Like new">Dell G-Seri
                      Like new</a>

                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/dell-inspiron-like-new.html" title="Dell Inspiron Like new">Dell
                      Inspiron Like new</a>

                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/dell-latitude-like-new.html" title="Dell Latitude Like new">Dell
                      Latitude Like new</a>

                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/dell-precision-like-new.html" title="Dell Precision Like new">Dell
                      Precision Like new</a>

                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/dell-xps-like-new.html" title="Dell XPS Like new">Dell XPS Like
                      new</a>

                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/dell-vostro-like-new.html" title="Dell Vostro Like new">Dell Vostro
                      Like new</a>
              ...
              <div class="danhmuc-2">
                ...
                <div class="danhmuc-3 d-flex flex-wrap">
                  ...
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/hp-elitebook-like-new.html" title="HP Elitebook Like new">HP Elitebook
                      Like new</a>
                  ...
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/hp-spectre-like-new.html" title="HP Spectre Like new">HP Spectre Like
                      new</a>

                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/hp-zbook-like-new.html" title="HP Zbook Like new">HP Zbook Like
                      new</a>

                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/hp-pavilion-like-new.html" title="HP Pavilion Like new">HP Pavilion
                      Like new</a>

                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/hp-probook-like-new.html" title="HP Probook Like new">HP Probook Like
                      new</a>

                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/hp-notebook-like-new.html" title="HP Notebook Like new">HP Notebook
                      Like new</a>
              ...
              <div class="danhmuc-2">
                ...
                <div class="danhmuc-3 d-flex flex-wrap">
                  ...
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/lenovo-ideapad-like-new.html" title="Lenovo Ideapad Like new">Lenovo
                      Ideapad Like new</a>

                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/lenovo-legion-like-new.html" title="Lenovo Legion Like new">Lenovo
                      Legion Like new</a>
                  ...
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/lenovo-thinkpad-like-new.html" title="Lenovo Thinkpad Like new">Lenovo
                      Thinkpad Like new</a>

                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/lenovo-yoga-like-new.html" title="Lenovo Yoga Like new">Lenovo Yoga
                      Like new</a>
              ...
              <div class="danhmuc-2">
                ...
                <div class="danhmuc-3 d-flex flex-wrap">
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/acer-aspire-like-new.html" title="Acer Aspire Like new">Acer Aspire
                      Like new</a>

                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/acer-nitro-like-new.html" title="Acer Nitro Like new">Acer Nitro Like
                      new</a>

                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/acer-predator-like-new.html" title="Acer Predator Like new">Acer
                      Predator Like new</a>

                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/acer-spin-like-new.html" title="Acer Spin Like new">Acer Spin Like
                      new</a>

                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/acer-swift-like-new.html" title="Acer Swift Like new">Acer Swift Like
                      new</a>
                  </div>
                </div>
              </div>
              <div class="danhmuc-2">
                ...
                <div class="danhmuc-3 d-flex flex-wrap">
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/asus-rog-like-new.html" title="Asus Rog Like new">Asus Rog Like
                      new</a>
                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/asus-zenbook-like-new.html" title="Asus ZenBook Like new">Asus ZenBook
                      Like new</a>
                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/asus-vivobook-like-new.html" title="Asus VivoBook Like new">Asus
                      VivoBook Like new</a>
                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/asus-tuf-like-new.html" title="Asus Tuf Like new">Asus Tuf Like
                      new</a>
                  </div>
                </div>
              </div>
              <div class="danhmuc-2">
                ...
                <div class="danhmuc-3 d-flex flex-wrap">
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/msi-bravo-like-new.html" title="MSI Bravo Like new">MSI Bravo Like
                      new</a>
                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/msi-g-seri-like-new.html" title="MSI G-Seri Like new">MSI G-Seri Like
                      new</a>
                  </div>
                  <div class="d-flex align-items item-3">
                    <!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                    <a href="/msi-modern-like-new.html" title="MSI Modern Like new">MSI Modern Like
                      new</a>
                  </div>
                </div>
              </div>
      ...
      <div class="item js-hover-menu">
        ...
        <a href="index.php?page=khuyenmai" class="root">KHUYẾN MÃI</a>
      </div>
      <div class="item js-hover-menu">
