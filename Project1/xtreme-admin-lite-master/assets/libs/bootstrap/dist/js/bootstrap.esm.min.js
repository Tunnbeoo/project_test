...
EventHandler.on(
  ...
  EventHandler.on(window, EVENT_LOAD_DATA_API, function () {
    for (
      var e = SelectorEngine.find(SELECTOR_DATA_RIDE), t = 0, n = e.length;
      t < n;
      t++
    )
      ...
      (t.dataApiKeydownHandler = function (e) {
        if (
          ...
          if (i && e.key !== SPACE_KEY) {
            var o = SelectorEngine.find(SELECTOR_VISIBLE_ITEMS, n).filter(
              isVisible
            );
            if (o.length) {
    ...
    return (
      ...
      (n._leave = function (e, t) {
        ...
        (t = t || Data.getData(e.delegateTarget, n)) ||
          ...
          e &&
          (t._activeTrigger[
            'focusout' === e.type ? TRIGGER_FOCUS : TRIGGER_HOVER
          ] = !1),
    ...
    return (
      ...
      (n._activate = function (e) {
        ...
        n.classList.contains(CLASS_NAME_DROPDOWN_ITEM)
          ...
          : (n.classList.add(CLASS_NAME_ACTIVE$2),
            SelectorEngine.parents(n, SELECTOR_NAV_LIST_GROUP).forEach(
              function (e) {
                SelectorEngine.prev(
                  e,
                  ...
                  SelectorEngine.prev(e, SELECTOR_NAV_ITEMS).forEach(function (
                    e
                  ) {
