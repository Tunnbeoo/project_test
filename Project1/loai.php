                    ...
                    <div class="sub_nav">
                      <div class="sub_filter">
                        <div class="list-unstyled sub_list-attr list_2col m-0 p-0 d-flex flex-wrap"> 
                            <div class="danhmuc-2">
                              <a href="index.php?page=loai&id=6" title="Laptop Dell Mới" class="title-danhmuc-2">Laptop Dell Mới</a>
                            ...
                            <div class="danhmuc-2">
                              <a href="index.php?page=loai&id=11" title="Laptop Acer Mới" class="title-danhmuc-2">Laptop CHUWI Mới</a>
                              <div class="danhmuc-3 d-flex flex-wrap">
                                <div class="d-flex align-items item-3"><!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
                            ...
                            <div class="danhmuc-2">
                              <a href="index.php?page=loai&id=9" title="Laptop HP Mới" class="title-danhmuc-2">Laptop HP Mới</a>
                              <div class="danhmuc-3 d-flex flex-wrap">
                                <div class="d-flex align-items item-3"><!--<i class="fa fa-angle-double-right" style="padding-right:3px;"></i>-->
