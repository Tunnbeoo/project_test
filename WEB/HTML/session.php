...
<body>
  ...
  <div class="next-header">
    <div class="next-header_in">
      <div class="logo_text" title="Trang chủ">
        <a href="/WEB/HTML/session.php"><img height="100%" src="https://cdn.divineshop.vn/static/b1402e84a947ed36cebe9799e47f61c2.svg" title="Trang chủ"></a>
        <h2>Divine Shop</h2>
      </div>
      <div class="seacher">
      ...
      <div class="form">
        <div class="lopdangnhapchung">
          ...
          <div class="namelogin" style="margin-top: -22px;transform: translateX(25px);width:auto; font-size:larger">
            <?php if (isset($_SESSION['user_id'])) : ?>
              <?= htmlspecialchars($user["name"]) ?>
            <?php endif; ?>
          </div>
          <div class="logout">
            <a href="ASMfinal.php" style="color: #fff;">Thoát </a>
          </div>
        </div>
        <div class="table-profile">
          <div class="table-profile-con"></div>
          <ul class="table-profile-list">
            <a href="">
              <li>Logout</li>
            </a>
          </ul>
  ...
  <div class="comlum_top">
    <?php
    $conn2 = mysqli_connect('localhost', 'root', '', 'shop');
  ...
  <div class="flash_sell">
    <div class="sell_product">
      ...
      <a href=""><img src="	https://cdn.divineshop.vn/static/1478de4bf059d759990c4849f3c3e8ce.svg" alt=""><b> #Sản phẩm bán chạy </b></a>
      <a href="">Khám phá</a>
    </div>
    <div class="comlum_top">
  ...
  <div class="entertaiment">
    ...
    <div class="colum">
      <img src="/img/Divine-Shop-Goi-price-Han-Spotify-1-Nam-40567 (1).jpg" alt="">
    ...
    <div>
      ...
      <div class="signup_1_1">
        <div class="signup_1_2">
          <a href="/WEB/HTML/formdk1.html">Đăng ký ngay</a>
        </div>
        <div class="sigup_2_1" style="width: 280px; height: 100%; color: white; ">Hoặc bạn đã có tài khoảng?
          <a href="/WEB/HTML/formdn.html" style="margin-left: 5px">
            <b style="color: white;"> Đăng nhập</b></a>
        </div>
      </div>
    </div>
...
<script>
  ...
  const dn = document.querySelector()
</script>
</body>
